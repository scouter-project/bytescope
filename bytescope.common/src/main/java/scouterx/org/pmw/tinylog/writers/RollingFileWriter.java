...
import scouterx.org.pmw.tinylog.EnvironmentHelper;
...
import scouterx.org.pmw.tinylog.policies.StartupPolicy;

/**
 * Writes log entries to a file like {@link FileWriter FileWriter} but keeps backups of old
 * logging files.
 */
...
public final class RollingFileWriter implements Writer {
	 ...
	 *            Number of backups
	 *
	 * @see scouterx.org.pmw.tinylog.policies.StartupPolicy
	 */
