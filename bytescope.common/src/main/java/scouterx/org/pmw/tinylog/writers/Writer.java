...
package scouterx.org.pmw.tinylog.writers;

import scouterx.org.pmw.tinylog.Configuration;
import scouterx.org.pmw.tinylog.LogEntry;

import java.util.Set;

/**
 * Writers output created log entries from {@link scouterx.org.pmw.tinylog.Logger Logger}.
 *
 * <p>
 * The annotation {@link scouterx.org.pmw.tinylog.writers.PropertiesSupport PropertiesSupport} must be added to the implemented
 * writer class and the implemented writer must be registered as service in "META-INF/services/scouterx.org.pmw.tinylog.writers"
...
public interface Writer {
	 ...
	 * registered in the <code>init()</code> method at {@link scouterx.org.pmw.tinylog.writers.VMShutdownHook VMShutdownHook} for
