...
package scouterx.org.pmw.tinylog.labelers;
...
/**
 * A labeler names log files and backups for {@link scouterx.org.pmw.tinylog.writers.RollingFileWriter RollingFileWriter}.
 *
 * <p>
 * The annotation {@link scouterx.org.pmw.tinylog.labelers.PropertiesSupport PropertiesSupport} must be added to the implemented
 * labeler class and the implemented labeler must be registered as service in
 * "META-INF/services/scouterx.org.pmw.tinylog.labelers" in order to make the labeler available by properties files and system
 * properties.
 * </p>
 *
 * <p>
